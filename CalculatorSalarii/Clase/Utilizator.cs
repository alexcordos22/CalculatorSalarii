...
namespace CalculatorSalarii
{
    public class Utilizator
    {
        ...
        {
            //ConnectionString
            string cs = ConfigurationManager.ConnectionStrings["AngajatiDB"].ConnectionString;
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Nume Utilizator/Parola exista in baza de date");
                ...
                else
                {
                    ...
                    MessageBox.Show("Un nou utilizator a fost adaugat cu succes", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
        ...
        public void StergereUtilizator(int id)
        {
            ...
            MessageBox.Show("Utilizatorul a fost sters cu succes", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
